...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      @guest
      <a href="/auth/signup" class="btn btn-outline-success me-3">вступить в ряды</a>
      <a href="/auth/login" class="btn btn-outline-success">обозначиться</a>
      @endguest
      @auth
      <a href="/auth/logout" class="btn btn-outline-success">свалить</a>
      @endauth
  </div>
  </div>
</nav>
