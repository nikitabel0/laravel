        ...
        @auth
         <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
            ...
            <li><a class="dropdown-item" href="{{route('article.show',['article'=>{notification->data['article']['id'], 'notify'->notification_id ])}}">{{notification->data['article']['name']}}:{{notification->data['comment_name']}}</a></li>
          @endforeach
          </ul>
