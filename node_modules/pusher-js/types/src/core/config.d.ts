import { Options } from 'pusher-js/types/src/core/options';
import { ChannelAuthorizationHandler, UserAuthenticationHandler } from 'pusher-js/types/src/core/auth/options';
